...
class Ui_Form2(object):
    ...
    def load_settings(self):
        saved_data = data_lib.get_data(os.path.join(os.getcwd(), 'data2.json'))
        ...
        try:
            ...
            None
        try:
            self.ZuzycieWodyZimnej.setText(str(saved_data['user_data_settings']['ZUZYCIE_KWH']))
        except:
            None
        try:
            self.ZuzycieWodyCieplej.setText(str(saved_data['user_data_settings']['STAWKA_KWH']))
        except:
            None
        try:
    ...
    def get_settings(self):
        ...
        doc_settings = {
            ...
            "user_data_settings": {
                ...
                "ZUZYCIE_KWH": self.ZuzycieWodyZimnej.text(),
                "STAWKA_KWH": self.ZuzycieWodyCieplej.text(),
                "MAIL": self.Mail.text(),
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "ROZLICZENIA --- PRAD"))
        self.label_7.setText(_translate("Form", "Auth"))
        self.label_12.setText(_translate("Form", "ZUZYCIE (KWH)"))
        self.label_13.setText(_translate("Form", "STAWKA ZA KWH"))
